...
class ActivityC : Activity() {
    ...
    public override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mStatusView = findViewById(R.id.status_view_c) as TextView
        mStatusAllView = findViewById(R.id.status_view_all_c) as TextView
    ...
    fun startDialog(v: View) {
        val intent = Intent(this@ActivityC, DialogActivity::class.java)
    ...
    fun finishActivityC(v: View) {
        this@ActivityC.finish()
    }
}
